...
/*   Updated: 2024/02/23 19:00:51 by gbrunet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(const Form &cpy): _name(cpy.getName()), _signed(cpy.getSigned()),
	...
	std::cout << CYAN << "Form " << cpy.getName() << "(" << cpy.getSigned() << ") with required grade ";
	std::cout << "for signing: " << cpy.getRequiredSign() << " and for executing: " << cpy.getRequiredExec();
	std::cout << " copied"<< END_STYLE << std::endl;	
}

Form::~Form() {
	std::cout << PURPLE << "Form " << this->_name << "(" << this->_signed << ") with required grade ";
...
Form	&Form::operator=(const Form &rhs) {
	...
	std::cout << CYAN << "Form " << rhs.getName() << "(" << rhs.getSigned() << ") with required grade ";
...
std::ostream	&operator<<(std::ostream &o, const Form &form) {
	o << "Form " << form.getName() << ", signed: " << form.getSigned();
